...
def init_Moveit():
    ...
    scene.add_box("table", p, (1.9, 1.9, 0.01))
    ...
    group_l.set_max_acceleration_scaling_factor(0.5)
    group_l.set_max_velocity_scaling_factor(0.5)
    ...
    group_r.set_max_acceleration_scaling_factor(0.5)
    group_r.set_max_velocity_scaling_factor(0.5)
    ...
    group_both.set_max_acceleration_scaling_factor(0.5)
    group_both.set_max_velocity_scaling_factor(0.5)
...
def reset_arm(arm):
    ...
    :rtype: None
    """
    safeJointPositionR = [0.0, -2.268927812576294, -2.356194496154785, 0.5235987901687622, 0.0, 0.6981316208839417, 0.0]
    safeJointPositionL = [0.0, -2.268927812576294, 2.356194496154785, 0.5235987901687622, 0.0, 0.6981316208839417, 0.0]
    global group_l
    global group_r
    global group_both
